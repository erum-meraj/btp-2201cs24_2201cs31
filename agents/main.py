...
def build_orchestrator(log_file: str = "agent_trace.txt", 
                      memory_manager = None) -> AgentOrchestrator:
    """
...
def calculate_experiment(dataset_obj: dict, experiment_index: int, 
    ...
    try:
        ...
        workflow_meta = dataset_obj.get("meta", {
            "name": f"workflow_{experiment_index}",
            "id": experiment_id
        })
        ...
        dataset = [{
            ...
            "environment": {
                ...
                "DR": {
                    ...
                    "(1,0)": 1e-6, "(1,1)": 0.0, "(1,2)": 2.5e-6,
                    "(2,0)": 3e-6, "(2,1)": 2.5e-6, "(2,2)": 0.0
                },
